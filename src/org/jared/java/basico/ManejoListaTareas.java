...
import org.jared.java.basico.modelo.ListaTareas;
import org.jared.java.basico.modelo.Tarea;

import java.io.*;
import java.util.ArrayList;
import java.util.List;

public class ManejoListaTareas {
    ...
    private ManejoTareas tareas = new ManejoTareas();


    public ManejoListaTareas() throws Exception {
        cargaTareas();
    }
